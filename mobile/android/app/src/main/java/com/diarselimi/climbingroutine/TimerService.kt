...
class TimerService : Service() {
  companion object {
    ...
    const val ACTION_START = "com.diarselimi.climbingroutine.TIMER_START"
    const val ACTION_UPDATE = "com.diarselimi.climbingroutine.TIMER_UPDATE"
    const val ACTION_STOP = "com.diarselimi.climbingroutine.TIMER_STOP"
    ...
    fun setMode(context: Context, mode: String) {
      val intent = Intent(context, TimerService::class.java).apply {
        action = "com.diarselimi.climbingroutine.TIMER_MODE"
        putExtra("mode", mode)
      }
      context.startService(intent)
    }
  ...
  override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
    when (intent?.action) {
      ...
      "com.diarselimi.climbingroutine.TIMER_MODE" -> {
        mode = intent.getStringExtra("mode") ?: mode
      }
      ACTION_STOP -> {
        handler.removeCallbacks(tick)
